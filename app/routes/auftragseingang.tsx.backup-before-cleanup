          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22 }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "170px 140px 1fr", gap: 12 }}>
                      ...
                      <>
                        ...
                        <div style={{ display: "grid", gap: 10 }}>
                          <label style={labelStyle}>
                            ...
                            <input
                              name="itemName"
                              placeholder="Freitext zur Position"
              ...
              return (
                <a
                  ...
                  style={{
                    ...
                    borderColor: data.selectedEmailCategory === key ? "#057a67" : "#cbd5e1",
                  }}
                >
                  {label} ({count})
                </a>
